...
export const metadata: Metadata = {
  title: 'Yash Mishra | AI/ML Engineer & Full Stack Developer',
  description: 'World-class developer portfolio of Yash Mishra, AI/ML Engineer, Data Analyst, Computer Vision Enthusiast & Full Stack Developer. Specialized in Deep Learning, PyTorch, MediaPipe & Next.js.',
  keywords: ['Yash Mishra', 'AI Engineer', 'ML Engineer', 'Data Analyst', 'Computer Vision', 'Deep Learning', 'IEEE Researcher', 'Next.js Developer', 'Portfolio'],
